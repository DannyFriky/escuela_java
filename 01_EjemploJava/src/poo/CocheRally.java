...
public class CocheRally extends Coche{
	...
	public CocheRally(String matricula, byte ruedas, String marca, int capacidad, TipoCarburante carburante, TipoColor color) {
		super(matricula, ruedas, marca, capacidad, carburante, color);
	}

//	public CocheRally(String marca){
//		super(marca);//para llamar a un constructor modificado
//		this.rozamiento = rozamiento;
//		
//	}
//	
//	public CocheRally(String matricula, byte ruedas,String marca, int capacidad, TipoCarburante carburante, TipoColor color, float rozamiento){
//		super(matricula, ruedas, marca, capacidad, carburante, color);//para llamar a un constructor modificado
//		this.rozamiento = rozamiento;
//		
//	}
//	
